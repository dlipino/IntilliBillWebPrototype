...
public class PatientsViewImpl<T> extends Composite implements PatientsView<T> {

  @UiTemplate("PatientsView.ui.xml")
  interface PatientsViewUiBinder extends UiBinder<Widget, PatientsViewImpl> {}
  private static PatientsViewUiBinder uiBinder = GWT.create(PatientsViewUiBinder.class);

  @UiField HTML patientsTable;
  ...
  public void setRowData(List<T> rowData) {
    ...
    patientsTable.setHTML(table.getInnerHTML());
  }
